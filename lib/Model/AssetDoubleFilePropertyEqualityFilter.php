...
/**
 * AssetDoubleFilePropertyEqualityFilter Class Doc Comment
 *
 * @category Class
 * @description Filter assets based on its double file properties
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AssetDoubleFilePropertyEqualityFilter extends AssetFilter
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetDoubleFilePropertyEqualityFilter';
