 ...
 *
 * @category Class
 * @description The instance of the external reference
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Instance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets key
     *
     * @param string|null $key The instance of the external reference
     *
     * @return self
     */
     ...
     * Sets labels
     *
     * @param array<string,string>|null $labels The labels of the instance
     *
     * @return self
     */
