...
/**
 * AssetVersionAddedEvent Class Doc Comment
 *
 * @category Class
 * @description Fired when an asset version is added
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AssetVersionAddedEvent extends Event
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetVersionAddedEvent';
    ...
    protected static $openAPITypes = [
        ...
        'asset_before' => '\Celum\Client\Model\Asset'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('asset_before', $data ?? [], null);
    }
    ...
    */
     ...
     * @return \Celum\Client\Model\Asset|null
     */
    public function getAssetBefore()
    {
        return $this->container['asset_before'];
    }

    /**
     * Sets asset_before
     *
     * @param \Celum\Client\Model\Asset|null $asset_before The asset before the update
     *
     * @return self
     */
    public function setAssetBefore($asset_before)
    {
        if (is_null($asset_before)) {
            throw new \InvalidArgumentException('non-nullable asset_before cannot be null');
        }
        $this->container['asset_before'] = $asset_before;
