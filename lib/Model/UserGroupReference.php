 ...
 *
 * @category Class
 * @description A reference to a user group
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UserGroupReference extends SubjectDto
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserGroupReference';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling UserGroupReference., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling UserGroupReference., must be bigger than or equal to 1.');
        }
