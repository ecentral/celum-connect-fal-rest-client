...
/**
 * SetRoleAssignments Class Doc Comment
 *
 * @category Class
 * @description Set collection role assignments
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SetRoleAssignments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetRoleAssignments';
    ...
    protected static $openAPITypes = [
        'role_id' => 'int',
        'assignees' => '\Celum\Client\Model\RoleAssigneeUpdate[]'
    ];
    ...
    */
     ...
     * Sets assignees
     *
     * @param \Celum\Client\Model\RoleAssigneeUpdate[]|null $assignees Assignees to set
     *
     * @return self
     */
