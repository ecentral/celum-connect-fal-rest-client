...
/**
 * AssetFileExtensionFilter Class Doc Comment
 *
 * @category Class
 * @description Filters assets by extension
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AssetFileExtensionFilter extends AssetFilter
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetFileExtensionFilter';
    ...
    */
     ...
     * Sets values
     *
     * @param string[] $values The values to search for
     *
     * @return self
     */
