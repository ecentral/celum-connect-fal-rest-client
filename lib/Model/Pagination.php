 ...
 *
 * @category Class
 * @description Number and size of the page of results
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Pagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets page
     *
     * @param int|null $page Number of the page of results
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size Size of the page of results, default is 20 but may change based on client ID and server-side configuration
     *
     * @return self
     */
