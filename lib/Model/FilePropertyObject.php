...
/**
 * FilePropertyObject Class Doc Comment
 *
 * @category Class
 ...
 */
class FilePropertyObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FilePropertyObject';
    ...
    protected static $openAPITypes = [
        ...
        'value' => 'mixed',
        'type' => '\Celum\Client\Model\FilePropertyObjectType'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param int $id The ID of the file property
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling FilePropertyObject., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling FilePropertyObject., must be bigger than or equal to 1.');
        }
     ...
     * Sets name
     *
     * @param string $name Name of the file property
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \Celum\Client\Model\FilePropertyObjectType
     */
     ...
     * Sets type
     *
     * @param \Celum\Client\Model\FilePropertyObjectType $type type
     *
     * @return self
     */
