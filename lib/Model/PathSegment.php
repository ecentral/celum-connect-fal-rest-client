 ...
 *
 * @category Class
 * @description Segment of a path to a collection or asset
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PathSegment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PathSegment';
    ...
    protected static $openAPITypes = [
        'collection_id' => 'int',
        'collection_name' => 'array<string,string>'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['collection_id'] > 9223372036854775807)) {
            $invalidProperties[] = "invalid value for 'collection_id', must be smaller than or equal to 9223372036854775807.";
        }

        if (($this->container['collection_id'] < 1)) {
            $invalidProperties[] = "invalid value for 'collection_id', must be bigger than or equal to 1.";
        }
     ...
     * Sets collection_id
     *
     * @param int $collection_id The associated collection ID.
     *
     * @return self
     */
    public function setCollectionId($collection_id)
    {
        ...
        if (($collection_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $collection_id when calling PathSegment., must be smaller than or equal to 9223372036854775807.');
        }
        if (($collection_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $collection_id when calling PathSegment., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param array<string,string> $collection_name Localized collection name
     *
     * @return self
     */
