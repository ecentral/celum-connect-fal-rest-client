...
/**
 * InformationFieldValueObjectObjectType Class Doc Comment
 *
 * @category Class
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InformationFieldValueObjectObjectType
{
    /**
    ...
    public const LOCALIZED_TEXT = 'LOCALIZED_TEXT';

    public const DOUBLE = 'DOUBLE';

    public const COLLECTION_REFERENCE = 'COLLECTION_REFERENCE';

    public const LOCALIZED_TEXT_AREA = 'LOCALIZED_TEXT_AREA';

    public const TAG_REFERENCE = 'TAG_REFERENCE';
