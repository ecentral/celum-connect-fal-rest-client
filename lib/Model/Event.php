 ...
 *
 * @category Class
 * @description Base type for events
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Event implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets user_id
     *
     * @param int $user_id ID of the user who triggered the event
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \Celum\Client\Model\EventType|null
     */
     ...
     * Sets type
     *
     * @param \Celum\Client\Model\EventType|null $type type
     *
     * @return self
     */
