...
/**
 * AssetFileCategoryFilter Class Doc Comment
 *
 * @category Class
 * @description Filter assets based on file categories
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AssetFileCategoryFilter extends AssetFilter
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetFileCategoryFilter';
    ...
    protected static $openAPITypes = [
        ...
        'values' => '\Celum\Client\Model\FileCategory[]'
    ];
    ...
    */
     ...
     * Sets values
     *
     * @param \Celum\Client\Model\FileCategory[] $values The values to search for
     *
     * @return self
     */
