...
/**
 * SetRequiredCollectionIds Class Doc Comment
 *
 * @category Class
 * @description Sets the required collection ids for a collection reference element rule
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SetRequiredCollectionIds extends UpdateRequiredCollectionIds
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetRequiredCollectionIds';
    ...
    */
     ...
     * Sets value
     *
     * @param int[] $value List of collection ids to set as the new rule or for the existing one.
     *
     * @return self
     */
