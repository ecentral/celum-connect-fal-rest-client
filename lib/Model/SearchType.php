 ...
 *
 * @category Class
 * @description Defines how the given search text is matched
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SearchType
{
    ...
    public const TERMS_STARTING_WITH = 'termsStartingWith';

    public const TERMS_ENDING_WITH = 'termsEndingWith';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::PHRASE,
            self::TERMS,
            self::TERMS_STARTING_WITH,
            self::TERMS_ENDING_WITH
        ];
    }
}
