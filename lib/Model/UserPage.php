 ...
 *
 * @category Class
 * @description Partial results of an user query - eventually split by pagination
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class UserPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'total_elements' => 'int',
        'has_next' => 'bool',
        'content' => '\Celum\Client\Model\User[]'
    ];
    ...
    */
    ...
    public function setTotalElements($total_elements)
    {
        ...
        if (($total_elements > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $total_elements when calling UserPage., must be smaller than or equal to 9223372036854775807.');
        }
        if (($total_elements < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_elements when calling UserPage., must be bigger than or equal to 0.');
        }
     ...
     * Gets content
     *
     * @return \Celum\Client\Model\User[]|null
     */
     ...
     * Sets content
     *
     * @param \Celum\Client\Model\User[]|null $content The elements of this page
     *
     * @return self
     */
