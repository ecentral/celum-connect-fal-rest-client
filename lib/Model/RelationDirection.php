...
/**
 * RelationDirection Class Doc Comment
 *
 * @category Class
 ...
 */
class RelationDirection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RelationDirection';
    ...
    public const TYPE_SOURCE_TO_TARGET = 'SOURCE_TO_TARGET';
    public const TYPE_TARGET_TO_SOURCE = 'TARGET_TO_SOURCE';
    ...
    {
        return [
            self::TYPE_SOURCE_TO_TARGET,
            self::TYPE_TARGET_TO_SOURCE,
        ];
    }
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Relation direction type
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param array<string,string>|null $message message
     *
     * @return self
     */
