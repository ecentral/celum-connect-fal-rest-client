...
class DropdownOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets index
     *
     * @param int $index The index of the drop down option
     *
     * @return self
     */
    public function setIndex($index)
    {
        ...
        if (($index < 0)) {
            throw new \InvalidArgumentException('invalid value for $index when calling DropdownOption., must be bigger than or equal to 0.');
        }
     ...
     * Sets label
     *
     * @param string $label The label of the drop down option
     *
     * @return self
     */
