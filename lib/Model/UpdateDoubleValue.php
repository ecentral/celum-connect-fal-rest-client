...
/**
 * UpdateDoubleValue Class Doc Comment
 *
 * @category Class
 * @description Base type for double value update operations, see oneOf for concrete types
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateDoubleValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateDoubleValue';
    ...
    protected static $openAPITypes = [
        'op' => '\Celum\Client\Model\UpdateDoubleValueOp',
        'value' => 'float'
    ];
    ...
    */
     ...
     * Gets op
     *
     * @return \Celum\Client\Model\UpdateDoubleValueOp
     */
     ...
     * Sets op
     *
     * @param \Celum\Client\Model\UpdateDoubleValueOp $op op
     *
     * @return self
     */
