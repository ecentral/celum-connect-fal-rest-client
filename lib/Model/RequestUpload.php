...
/**
 * RequestUpload Class Doc Comment
 *
 * @category Class
 * @description Attributes of an upload request
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RequestUpload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestUpload';
    ...
    */
     ...
     * Sets filesize
     *
     * @param int $filesize The size of the file to be uploaded in bytes
     *
     * @return self
     */
    public function setFilesize($filesize)
    {
        ...
        if (($filesize < 0)) {
            throw new \InvalidArgumentException('invalid value for $filesize when calling RequestUpload., must be bigger than or equal to 0.');
        }
