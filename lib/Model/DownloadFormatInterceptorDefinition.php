...
/**
 * DownloadFormatInterceptorDefinition Class Doc Comment
 *
 * @category Class
 * @description Defines the actions to be done during a download
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DownloadFormatInterceptorDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DownloadFormatInterceptorDefinition';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The ID of the interceptor definition
     *
     * @return self
     */
     ...
     * Sets options
     *
     * @param array<string,string> $options Interceptor options
     *
     * @return self
     */
