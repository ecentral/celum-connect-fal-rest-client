...
/**
 * UpdateRequiredCollectionIds Class Doc Comment
 *
 * @category Class
 * @description Base type for updating required elements for an element rule
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateRequiredCollectionIds implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateRequiredCollectionIds';
