...
/**
 * UserGroupPage Class Doc Comment
 *
 * @category Class
 * @description Partial results of a user group query - eventually split by pagination
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UserGroupPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserGroupPage';
    ...
    protected static $openAPITypes = [
        'total_elements' => 'int',
        'has_next' => 'bool',
        'content' => '\Celum\Client\Model\UserGroup[]'
    ];
    ...
    */
    ...
    public function setTotalElements($total_elements)
    {
        ...
        if (($total_elements > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $total_elements when calling UserGroupPage., must be smaller than or equal to 9223372036854775807.');
        }
        if (($total_elements < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_elements when calling UserGroupPage., must be bigger than or equal to 0.');
        }
     ...
     * Gets content
     *
     * @return \Celum\Client\Model\UserGroup[]|null
     */
     ...
     * Sets content
     *
     * @param \Celum\Client\Model\UserGroup[]|null $content The elements of this page
     *
     * @return self
     */
