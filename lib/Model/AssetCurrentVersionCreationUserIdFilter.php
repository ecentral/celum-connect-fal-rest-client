...
/**
 * AssetCurrentVersionCreationUserIdFilter Class Doc Comment
 *
 * @category Class
 * @description Filter assets based on current version created by user id
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AssetCurrentVersionCreationUserIdFilter extends AssetFilter
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetCurrentVersionCreationUserIdFilter';
