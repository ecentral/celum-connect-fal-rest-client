...
/**
 * CollectionReference Class Doc Comment
 *
 * @category Class
 * @description The reference to another collection
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CollectionReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CollectionReference';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id The ID of the referenced entity.
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling CollectionReference., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling CollectionReference., must be bigger than or equal to 1.');
        }
     ...
     * Sets name
     *
     * @param array<string,string>|null $name Name of the referenced collection - only the names of X collections will be resolved where X is the value of the server-side configuration property 'rest.informationFields.maxReferenceNames'
     *
     * @return self
     */
