...
/**
 * AssetCurrentVersionCreationDateRangeFilter Class Doc Comment
 *
 * @category Class
 * @description Filter assets based on current version creation date range
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AssetCurrentVersionCreationDateRangeFilter extends AssetFilter
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetCurrentVersionCreationDateRangeFilter';
    ...
    */
     ...
     * Sets from
     *
     * @param \DateTime|null $from The lower bound value of a range
     *
     * @return self
     */
