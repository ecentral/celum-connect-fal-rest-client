 ...
 *
 * @category Class
 * @description Contains all languages used
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Languages implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets system
     *
     * @param string|null $system The default language
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $information_fields The languages for information fields
     *
     * @return self
     */
