...
/**
 * AssetParentIdFilter Class Doc Comment
 *
 * @category Class
 * @description Filter assets based on parent collection IDs
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AssetParentIdFilter extends AssetFilter
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetParentIdFilter';
    ...
    public const MATCHER_ALL = 'ALL';
    public const MATCHER_ANY = 'ANY';
     ...
     * @return string[]
     */
    public function getMatcherAllowableValues()
    {
        return [
            self::MATCHER_ALL,
            self::MATCHER_ANY,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('matcher', $data ?? [], 'ALL');
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getMatcherAllowableValues();
        if (!is_null($this->container['matcher']) && !in_array($this->container['matcher'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'matcher', must be one of '%s'",
                $this->container['matcher'],
     ...
     * Sets values
     *
     * @param int[] $values The values to search for
     *
     * @return self
     */
     ...
     * Sets recursive
     *
     * @param bool|null $recursive Enable search in child collections
     *
     * @return self
     */
     ...
     * Sets matcher
     *
     * @param string|null $matcher Matcher for multiple parent ids
     *
     * @return self
     */
    public function setMatcher($matcher)
    {
        ...
        $allowedValues = $this->getMatcherAllowableValues();
        if (!in_array($matcher, $allowedValues, true)) {
