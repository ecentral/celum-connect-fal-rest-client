...
/**
 * AssetAvailabilityDateRangeFilter Class Doc Comment
 *
 * @category Class
 * @description Filter assets based on availability in given date range
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AssetAvailabilityDateRangeFilter extends AssetFilter
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetAvailabilityDateRangeFilter';
    ...
    */
     ...
     * Sets from
     *
     * @param \DateTime $from The lower bound value of a range
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param \DateTime $to The upper bound value of a range - either 'from' or 'to' must be set
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool $active Status of Asset
     *
     * @return self
     */
