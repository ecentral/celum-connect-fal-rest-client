...
/**
 * AssetPage Class Doc Comment
 *
 * @category Class
 * @description Partial results of an asset query - eventually split by pagination; information fields may or may not be included based on client ID and server-side configuration
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AssetPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetPage';
    ...
    protected static $openAPITypes = [
        'total_elements' => 'int',
        'has_next' => 'bool',
        'content' => '\Celum\Client\Model\Asset[]'
    ];
    ...
    */
    ...
    public function setTotalElements($total_elements)
    {
        ...
        if (($total_elements > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $total_elements when calling AssetPage., must be smaller than or equal to 9223372036854775807.');
        }
        if (($total_elements < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_elements when calling AssetPage., must be bigger than or equal to 0.');
        }
     ...
     * Sets content
     *
     * @param \Celum\Client\Model\Asset[]|null $content The elements of this page
     *
     * @return self
     */
