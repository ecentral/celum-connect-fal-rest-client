...
/**
 * ValidationFaultType Class Doc Comment
 *
 * @category Class
 * @package  Celum\Client
 * @author   OpenAPI Generator team
...
class ValidationFaultType
{
    ...
    public const INFORMATION_FIELD = 'INFORMATION_FIELD';

    public const LOCALIZED_ARGUMENT = 'LOCALIZED_ARGUMENT';
