...
/**
 * UpdateCompoundObjectTypeKey Class Doc Comment
 *
 * @category Class
 * @description Base type for updating compound objects type for a collection
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateCompoundObjectTypeKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateCompoundObjectTypeKey';
