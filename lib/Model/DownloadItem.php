...
/**
 * DownloadItem Class Doc Comment
 *
 * @category Class
 * @description An item of a download job
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DownloadItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DownloadItem';
    ...
    */
     ...
     * Sets asset_id
     *
     * @param int $asset_id The ID of the asset to download
     *
     * @return self
     */
     ...
     * Sets format_id
     *
     * @param int $format_id The ID of the download format
     *
     * @return self
     */
