 ...
 *
 * @category Class
 * @description Partial results of a collection query - eventually split by pagination
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CollectionPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'total_elements' => 'int',
        'has_next' => 'bool',
        'content' => '\Celum\Client\Model\Collection[]'
    ];
    ...
    */
    ...
    public function setTotalElements($total_elements)
    {
        ...
        if (($total_elements > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $total_elements when calling CollectionPage., must be smaller than or equal to 9223372036854775807.');
        }
        if (($total_elements < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_elements when calling CollectionPage., must be bigger than or equal to 0.');
        }
     ...
     * Sets content
     *
     * @param \Celum\Client\Model\Collection[]|null $content The elements of this page
     *
     * @return self
     */
