...
/**
 * UpdateAlternativePreview Class Doc Comment
 *
 * @category Class
 * @description Updates the alternative preview of an asset using the handle of a previously uploaded file.
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateAlternativePreview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateAlternativePreview';
    ...
    */
     ...
     * Sets upload_handle
     *
     * @param string|null $upload_handle The alternative upload handle of the asset
     *
     * @return self
     */
