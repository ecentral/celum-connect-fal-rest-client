 ...
 *
 * @category Class
 * @description The locking status of an asset
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Lock implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets temporary
     *
     * @param bool $temporary Is the lock temporary?
     *
     * @return self
     */
     ...
     * Sets comment
     *
     * @param string|null $comment The comment of the lock status
     *
     * @return self
     */
     ...
     * Sets creation
     *
     * @param \Celum\Client\Model\Trail|null $creation The creation information of the entity with time and user
     *
     * @return self
     */
