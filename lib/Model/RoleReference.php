...
class RoleReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RoleReference';
    ...
    */
     ...
     * Sets name
     *
     * @param array<string,string>|null $name Localized role name
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param array<string,string>|null $description Localized role description
     *
     * @return self
     */
