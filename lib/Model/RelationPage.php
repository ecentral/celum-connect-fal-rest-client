...
/**
 * RelationPage Class Doc Comment
 *
 * @category Class
 * @description Partial results of a relation query - eventually split by pagination; information fields may or may not be included based on client ID and server-side configuration
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RelationPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RelationPage';
    ...
    protected static $openAPITypes = [
        'total_elements' => 'int',
        'has_next' => 'bool',
        'content' => '\Celum\Client\Model\Relation[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['total_elements'] > 9223372036854775807)) {
            $invalidProperties[] = "invalid value for 'total_elements', must be smaller than or equal to 9223372036854775807.";
        }
     ...
     * Sets total_elements
     *
     * @param int $total_elements The total number of available records
     *
     * @return self
     */
    public function setTotalElements($total_elements)
    {
        ...
        if (($total_elements > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $total_elements when calling RelationPage., must be smaller than or equal to 9223372036854775807.');
        }
        if (($total_elements < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_elements when calling RelationPage., must be bigger than or equal to 0.');
        }
     ...
     * Sets has_next
     *
     * @param bool $has_next Are there more elements?
     *
     * @return self
     */
     ...
     * Gets content
     *
     * @return \Celum\Client\Model\Relation[]|null
     */
     ...
     * Sets content
     *
     * @param \Celum\Client\Model\Relation[]|null $content The elements of this page
     *
     * @return self
     */
