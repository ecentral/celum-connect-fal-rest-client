...
/**
 * AssetLogicalFilter Class Doc Comment
 *
 * @category Class
 * @description Multiple asset filters combined with a logical AND|OR operator
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AssetLogicalFilter extends AssetFilter
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetLogicalFilter';
    ...
    protected static $openAPITypes = [
        ...
        'operator' => 'string',
        'filters' => '\Celum\Client\Model\AssetFilter[]'
    ];
    ...
    */
     ...
     * Sets filters
     *
     * @param \Celum\Client\Model\AssetFilter[] $filters The list of filters to be combined with logical operator
     *
     * @return self
     */
