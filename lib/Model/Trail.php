...
/**
 * Trail Class Doc Comment
 *
 * @category Class
 * @description Tracking information on changes of an entity by a user
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Trail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Trail';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['user_id']) && ($this->container['user_id'] > 9223372036854775807)) {
            $invalidProperties[] = "invalid value for 'user_id', must be smaller than or equal to 9223372036854775807.";
        }
     ...
     * Sets date
     *
     * @param \DateTime|null $date The date when an entity was changed
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param int|null $user_id The ID of the user, who changed the entity
     *
     * @return self
     */
    public function setUserId($user_id)
    {
        ...
        if (($user_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $user_id when calling Trail., must be smaller than or equal to 9223372036854775807.');
        }
        if (($user_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $user_id when calling Trail., must be bigger than or equal to 1.');
        }
