...
/**
 * UpdateTextValue Class Doc Comment
 *
 * @category Class
 * @description Base type for text value update operations, see oneOf for concrete types
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateTextValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateTextValue';
    ...
    protected static $openAPITypes = [
        'op' => '\Celum\Client\Model\UpdateTextValueOp',
        'value' => 'string'
    ];
    ...
    */
     ...
     * Gets op
     *
     * @return \Celum\Client\Model\UpdateTextValueOp
     */
     ...
     * Sets op
     *
     * @param \Celum\Client\Model\UpdateTextValueOp $op op
     *
     * @return self
     */
