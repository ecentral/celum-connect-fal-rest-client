...
/**
 * LocalizedTextField Class Doc Comment
 *
 * @category Class
 * @description A localized text information field
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LocalizedTextField extends InformationFieldObject
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LocalizedTextField';
    ...
    */
    ...
    public function setMinLength($min_length)
    {
        ...
        if (($min_length < 0)) {
            throw new \InvalidArgumentException('invalid value for $min_length when calling LocalizedTextField., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxLength($max_length)
    {
        ...
        if (($max_length > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $max_length when calling LocalizedTextField., must be smaller than or equal to 9223372036854775807.');
        }
