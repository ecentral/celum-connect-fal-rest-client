...
/**
 * UpdateInformationFieldValueObject Class Doc Comment
 *
 * @category Class
 * @description Update an information field
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateInformationFieldValueObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateInformationFieldValueObject';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id ID of the information field
     *
     * @return self
     */
