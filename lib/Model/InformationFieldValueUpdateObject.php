...
/**
 * InformationFieldValueUpdateObject Class Doc Comment
 *
 * @category Class
 * @description Base type for information field value updates
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InformationFieldValueUpdateObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InformationFieldValueUpdateObject';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'value' => 'mixed',
        'type' => '\Celum\Client\Model\InformationFieldValueUpdateObjectType'
    ];
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InformationFieldValueUpdateObject., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InformationFieldValueUpdateObject., must be bigger than or equal to 1.');
        }
     ...
     * Gets type
     *
     * @return \Celum\Client\Model\InformationFieldValueUpdateObjectType
     */
     ...
     * Sets type
     *
     * @param \Celum\Client\Model\InformationFieldValueUpdateObjectType $type type
     *
     * @return self
     */
