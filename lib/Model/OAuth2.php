 ...
 *
 * @category Class
 * @description Represents client OAuth2 details
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class OAuth2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url The authorization provider url
     *
     * @return self
     */
     ...
     * Sets client_id
     *
     * @param string|null $client_id The client id for a specific client
     *
     * @return self
     */
