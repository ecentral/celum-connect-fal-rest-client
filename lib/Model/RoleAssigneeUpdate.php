...
/**
 * RoleAssigneeUpdate Class Doc Comment
 *
 * @category Class
 * @description User or User Group to assign or unassign a role
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RoleAssigneeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RoleAssigneeUpdate';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/USER|USER_GROUP/", $this->container['type'])) {
            $invalidProperties[] = "invalid value for 'type', must be conform to the pattern /USER|USER_GROUP/.";
        }
     ...
     * Sets type
     *
     * @param string $type Type of assignee
     *
     * @return self
     */
    public function setType($type)
    {
        ...
        if ((!preg_match("/USER|USER_GROUP/", ObjectSerializer::toString($type)))) {
            throw new \InvalidArgumentException("invalid value for \$type when calling RoleAssigneeUpdate., must conform to the pattern /USER|USER_GROUP/.");
        }
     ...
     * Sets subject_id
     *
     * @param int $subject_id ID of the assignee
     *
     * @return self
     */
