...
/**
 * CollectionNegationFilter Class Doc Comment
 *
 * @category Class
 * @description Negation for a collection filter
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CollectionNegationFilter extends CollectionFilter
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CollectionNegationFilter';
    ...
    */
     ...
     * Sets filter
     *
     * @param \Celum\Client\Model\CollectionFilter $filter The filter to be negated
     *
     * @return self
     */
