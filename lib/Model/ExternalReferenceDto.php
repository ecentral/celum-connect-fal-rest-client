...
/**
 * ExternalReferenceDto Class Doc Comment
 *
 * @category Class
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExternalReferenceDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExternalReferenceDto';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'description' => '\Celum\Client\Model\Description',
        'url' => 'string',
        'provider' => '\Celum\Client\Model\Provider',
        'instance' => '\Celum\Client\Model\Instance',
        'updated' => '\DateTime'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The id of the external reference
     *
     * @return self
     */
     ...
     * Gets description
     *
     * @return \Celum\Client\Model\Description|null
     */
     ...
     * Sets description
     *
     * @param \Celum\Client\Model\Description|null $description description
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The url of the external reference
     *
     * @return self
     */
     ...
     * Gets provider
     *
     * @return \Celum\Client\Model\Provider|null
     */
     ...
     * Sets provider
     *
     * @param \Celum\Client\Model\Provider|null $provider provider
     *
     * @return self
     */
     ...
     * Gets instance
     *
     * @return \Celum\Client\Model\Instance|null
     */
     ...
     * Sets instance
     *
     * @param \Celum\Client\Model\Instance|null $instance instance
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated The date when an entity was changed
     *
     * @return self
     */
