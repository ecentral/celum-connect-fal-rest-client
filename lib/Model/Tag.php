    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling Tag., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
     ...
     * Sets name
     *
     * @param string|null $name Name of the referenced tag - only the names of X tags will be resolved where X is the value of the server-side configuration property 'rest.informationFields.maxReferenceNames'
     *
     * @return self
     */
