...
/**
 * AssetTypePermissions Class Doc Comment
 *
 * @category Class
 * @description User permissions for asset types.
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AssetTypePermissions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetTypePermissions';
    ...
    {
        $this->setIfExists('assign', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['assign'] === null) {
            $invalidProperties[] = "'assign' can't be null";
        }
     ...
     * Sets assign
     *
     * @param bool $assign Is an assignment permitted?
     *
     * @return self
     */
    ...
    {
        if (is_null($assign)) {
            throw new \InvalidArgumentException('non-nullable assign cannot be null');
        }
