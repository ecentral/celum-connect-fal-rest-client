...
/**
 * CollectionParentIdFilter Class Doc Comment
 *
 * @category Class
 * @description Filter collections based on parent ID. May only be used once and is always with a logical AND operator only at top level
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CollectionParentIdFilter extends CollectionFilter
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CollectionParentIdFilter';
