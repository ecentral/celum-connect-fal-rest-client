...
/**
 * Signing Class Doc Comment
 *
 * @category Class
 * @description Contains all information used for event signing
 * @package  Celum\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Signing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Signing';
    ...
    protected static $attributeMap = [
        'key_pair_algorithm' => 'keyPairAlgorithm',
    ...
    protected static $setters = [
        'key_pair_algorithm' => 'setKeyPairAlgorithm',
    ...
    protected static $getters = [
        'key_pair_algorithm' => 'getKeyPairAlgorithm',
    ...
    {
        $this->setIfExists('key_pair_algorithm', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets key_pair_algorithm
     *
     * @return string|null
     */
    public function getKeyPairAlgorithm()
    {
        return $this->container['key_pair_algorithm'];
    }

    /**
     * Sets key_pair_algorithm
     *
     * @param string|null $key_pair_algorithm The key pair algorithm
     *
     * @return self
     */
    public function setKeyPairAlgorithm($key_pair_algorithm)
    {
        if (is_null($key_pair_algorithm)) {
            throw new \InvalidArgumentException('non-nullable key_pair_algorithm cannot be null');
        }
        $this->container['key_pair_algorithm'] = $key_pair_algorithm;
     ...
     *
     * @param string|null $signature_algorithm The signature algorithm
     *
     * @return self
     */
     ...
     * Sets public_key
     *
     * @param string|null $public_key The encoded publicKey used for signing
     *
     * @return self
     */
